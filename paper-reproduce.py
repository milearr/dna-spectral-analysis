...
# Figure 3
os.system("python3 main.py -a file-mode -p './database-seq/YPL230W.fasta'")
...
os.system("python3 main.py -a database-mode -n 200 './database-cerevisiae/'")
os.system("python3 main.py -a statistics-mode './database-cerevisiae/'")
